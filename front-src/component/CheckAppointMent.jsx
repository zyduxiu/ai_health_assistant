...
function CheckPay() {
    ...
    useEffect(() => {
        fetch(`${config.apiBaseUrl}/api/allpaid/doctor`,{credentials: "include",})
            .then(response => {
    ...
    const handleButtonClick = () => {
        navigate('/doctorCall', { state: { membername: selectedCustomer.name} }); // 直接调用 navigate 来跳转
    };
    ...
    return patients && (
        ...
        <div className='split-into-left-right'>
                ...
                <div style={{ padding: 24, marginTop: 80, background: colorBgContainer, borderRadius: borderRadiusLG, marginBottom: 24 }}>
                    <Row  gutter={16} justify="space-between" align="middle">
                        ...
                        <Col>
                            ...
                            {selectedCustomer&&selectedCustomer.attribute === '已诊'&&false && (
                            ...
                            {selectedCustomer&&selectedCustomer.attribute === '已诊' &&false && (<PayFromMemberCard currentAppointment={selectedCustomer}/>)}
                    ...
                    <div style={{ padding: 24, marginTop: 80, background: colorBgContainer, borderRadius: borderRadiusLG, marginBottom: 24 }}>
                        <Row  gutter={16} justify="space-between" align="middle">
                            ...
                            <Col>
                                <Button
                                    type="primary"
                                    onClick={() => navigate('/doctorCall', { state: { customer: selectedCustomer } })}
                                >
                                    进入医生呼叫
                                </Button>
                            </Col>
            ...
            <div style={{ padding: 24, background: colorBgContainer, borderRadius: borderRadiusLG }}>
                ...
                {selectedCustomer&&selectedCustomer.attribute !== '已预约' && (
                    <div>
                    <TextArea rows={12} value={instruction} onChange={handleInstruction}/>
