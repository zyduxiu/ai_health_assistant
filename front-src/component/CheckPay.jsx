...
function CheckPay() {
    ...
    useEffect(() => {
        fetch(`${config.apiBaseUrl}/api/paid`,{credentials: "include",})
            .then(response => {
                ...
                <div style={{ padding: 24, marginTop: 80, background: colorBgContainer, borderRadius: borderRadiusLG, marginBottom: 24 }}>
                    <Row  gutter={16} justify="space-between" align="middle">
                        ...
                        <Col>
                            ...
                            {selectedCustomer.attribute!== '已付费' && (
                            ...
                            {selectedCustomer.attribute!== '已付费'&&<PayFromMemberCard currentAppointment={selectedCustomer}/>}
